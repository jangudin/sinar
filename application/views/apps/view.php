            ...
            <div class="col-md-4">
                <div class="card bg-light">
                    ...
                    <div class="card-body text-center">
                        <a href="<?php echo site_url('user/edit/'.$user->id); ?>" class="btn btn-warning btn-block mb-2">
                            <i class="fas fa-edit"></i> Edit Data
                        </a>
                        <a href="<?php echo site_url('user/delete/'.$user->id); ?>" class="btn btn-danger btn-block" onclick="return confirm('Yakin ingin menghapus user ini?')">
