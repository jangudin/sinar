              ...
              <form class="form-horizontal form-label-left" action="<?= base_url('Surat_tugas/ttesurtug') ?>" method="post" enctype="multipart/form-data">
                <div class="form-group row">
                  ...
                  <div class="col-md-6 col-sm-6 ">
                    ...
                    <input type="hidden" value="<?=$p->pengajuan_id ?>" name="id_rekomendasi" required="required" class="form-control  ">
                    <input type="hidden" value="<?=$jns ?>" name="jenis" required="required" class="form-control  ">
                  </div>
                </div>
                <div class="form-group row">
