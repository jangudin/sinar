...
<html lang="en">
  <head>
    ...
    <body class="text-centre">
        ...
        <div id="watermark">
            <img src="https://sinar.kemkes.go.id/assets/sertifikat/larsLembaga.png" height="100%" width="100%" />
        </div>
        <main>
       ...
       <div class="sertifikat-tingkat">
            <h2 class="mt-4 mb-5">MUTU AKREDITASI</h2>
            <?php if ($s->capayan == 'Paripurna'): ?>
            <img src="https://sinar.kemkes.go.id/assets/capayan/capayanParipurna.png" alt="" height=65 class="capayanimgparipurna"></img>
            <?php elseif ($s->capayan == 'Utama'): ?>
            <img src="https://sinar.kemkes.go.id/assets/capayan/capayanUtama.png" alt="" height=65 height="370" class="capayanimgutama"></img> 
            <?php elseif ($s->capayan == 'Madya'): ?>
            <img src="https://sinar.kemkes.go.id/assets/capayan/capayanMadya.png" alt="" height=65 height="370" class="capayanimgmadya"></img>
            <?php endif; ?>
             <!-- <img src="https://sinar.kemkes.go.id/assets/capayan/capayanParipurna.png" alt="" height=65 class="capayanimgparipurna"></img> -->
             <!-- <img src="https://sinar.kemkes.go.id/assets/capayan/capayanUtama.png" alt="" height=65 height="370" class="capayanimgutama"></img> -->
             <!-- <img src="https://sinar.kemkes.go.id/assets/capayan/capayanMadya.png" alt="" height=65 height="370" class="capayanimgmadya"></img> -->
