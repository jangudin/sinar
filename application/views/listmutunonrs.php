            ...
            <tbody>
              ...
              foreach ($databelum as $a) { ?>
                <tr>
                  ...
                  <td>
                    <a type="button" class="btn btn-success btn-sm" href="<?php echo base_url('Mutu_fasyankes/Detailnonrs/' . $a->jenis_fasyankes_nama . '/' . $a->fasyankes_id . '/' . $a->id) ?>">Verifikasi</a>
                  </td>
                </tr>
                <!-- Modal Catatan Ketua TIM -->
