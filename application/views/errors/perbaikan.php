...
<html>
  ...
  <body bgcolor="2e2929">
    <article>
        <h3>Sedang dalam maintenance</h3>
        <div>
            <p>Yth bapak / Ibu pengguna Aplikasi Sinar 
              <br>Sehubungan dengan perawatan server Aplikasi Sinar Maka Kami informasikan bahwa saat ini aplikasi sedang dalam maintenance </p>
            <p>&mdash; The Team</p>
