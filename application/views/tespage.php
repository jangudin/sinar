...
<body class="text-centre">
  ...
  <main>
    <div class="sertifikat-nomor">
      <p style="font-size: 20px;">Nomor : YMD.02.03/2/700002/2023</p>
    </div>
    <table style="padding-left: 145px; padding-top:80px;">
      <thead>
        <tr>
          <td>Klinik</td>
          <td>:</td>
          <th style="font-size: 20px;">Klinik Mamah LIA</th>
        </tr>
      </thead>
      <tbody>
        <tr>
          <td>Alamat  </td>
          <td>:</td>
          <td>KP.Ciwadas Girang Desa linggaraja Tasikmalaya Jawabarat</td>
        </tr>
        <tr>
          <td>Kecamatan</td>
          <td>:</td>
    ...
    <div class="berlaku">
      <p class="desc">Masa Berlaku : 01 Juni 2023 s.d 31 Mei 2028</p>
    </div>
    <div class="tglsekarang">
      <p class="mt-4">Jakarta, <?= format_indo(date('Y-m-d'));?></p>
    </div>
    <div class="ttdlembaga">
     <img src="https://sinar.kemkes.go.id/assets/ttdfaskes/lmn.jpg" height=90 class="ceter">
   </div>
   <div class="ttddirjen">
     <img src="https://sinar.kemkes.go.id/assets/ttdfaskes/ttedirmutu.png" height=90 class="ceter">
   </div>
 </main>
</body>
</html>