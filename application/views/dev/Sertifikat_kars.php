...
<body>
    <div id="allbox">
        <div id="boxsatu"><img src="<?php echo base_url('assets/bgsertifikat/KARS1-kosong.png')?>" height="1585"></div>
    </div>
    <br />
    <br />
    <br />
    ...
    <table class="center" style="text-align: center;">
        <tr>
        <td style="font-size:30px;">Nomor : 21092022/IX/1022</td>
        </tr>
    </table>
<br><br><br><br><br>
    <table class="center" style="text-align: center;">
    ...
    <table class="center" style="text-align: center;">
        ...
        <tr>
            <td style="font-weight: bold; font-size:35px">UTAMA</td>
        </tr>
        <tr>
    ...
    <table  class="center" style="text-align: center;">
        <tr>
        <td style="font-size:35px; margin-top:20px;">Jakarta, 5 Oktober 2022</td>
        </tr>
    </table><br>
