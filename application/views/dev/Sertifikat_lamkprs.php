...
<body>
    ...
    <div id="allbox">
        <!-- Start : Tampilkan Box -->
        <div id="boxsatu"><img src="<?php echo base_url('assets/bgsertifikat/LAM-KPRS-kosong.png')?>" height="1540"></div>
        <!-- End : Tampilan Box -->
    </div>
    <br />
    <br />
    ...
    <table class="center" style="text-align: center;">
        <tr>
        <td style="font-weight: bold; font-size:39px">SERTIFIKAT AKREDITASI RUMAH SAKIT</td>
        </tr>
        <tr>
...
<br><br><br><br><br><br>
    <table class="center" style="text-align: center;">
        ...
        <tr>
            <td style="font-weight: bold; font-size:35px">RSUD Kebayoran Lama</td>
        </tr>
        <tr>
            <td style="font-size:35px;">Alamat : Kuningan Setiaabudi</td>
        </tr>
