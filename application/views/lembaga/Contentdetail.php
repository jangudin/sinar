                      ...
                      <form class="form-horizontal form-label-left" action="<?= base_url('Lembaga/lembagatte') ?>" method="post" enctype="multipart/form-data">
                          <div class="form-group row">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                              <input type="text" value="<?= $nik ?>" name="nik"  required="required" class="form-control" >
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                              <input type="password" id="last-name" value="!Bsre1221*" name="passphrase" required="required" class="form-control ">
                            </div>
                          </div>
                          <div class="ln_solid">
