    ...
    <body class="text-centre">
        ...
        <main>
          ...
          <?php if ($s->jenis_faskes == 'Pusat Kesehatan Masyarakat'): ?>
                ...
                <p class="mt-4">Jakarta, <?= format_indo($s->tgl_surat);?></p>
                </div>
              <?php elseif ($s->jenis_faskes == 'Klinik'): ?>
                <div class="tglsekarang">
                <p class="mt-3">Jakarta, <?= format_indo($s->tgl_surat);?></p>
                </div>
                <div class="atasnama">
          ...
          <div class="ttddirjen">
              ...
              <?php elseif ($s->jenis_faskes == 'Klinik'): ?>
                <img src="https://sinar.kemkes.go.id/assets/ttdfaskes/ttedirmutu1.png" height=90 class="ceter">
              <?php endif; ?>
          </div>
        </main>
      <?php } ?>
