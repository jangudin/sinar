            ...
            <div class="row">
              <div class="col-md-12 col-sm-12  ">
                ...
                <?php if($attachment): ?>
                  ...
                  <?php if ($s->lpa == "KEMENKES"): ?>
                             <form class="form-horizontal form-label-left" action="<?= base_url('AkreditasiNonRS/prosesvalidasilembaga') ?>" method="post" enctype="multipart/form-data">
                          <div class="form-group row">
                            <div class="col-md-6 col-sm-6 ">
                              <input type="hidden" value="<?=$s->lpa_id ?>" name="lembaga" required="required" class="form-control">
                              <input type="hidden" value="<?=$s->id ?>" name="sertifikat_nomor_id" required="required" class="form-control">
                              <input type="hidden" value="<?=$s->jenis_faskes ?>" name="jenis" required="required" class="form-control">
                              <input type="hidden" value="<?=$idp ?>" name="idp" required="required" class="form-control  ">
                              <input type="hidden" value="<?=$s->kode_faskes ?>" name="id" required="required" class="form-control  ">
                            </div>
                          </div>
                                        <div class="ln_solid">
                                            <div class="form-group">
                                                <div class="col-md-6 offset-md-3">
                                                  <br>
                                                    <button type='submit' class="btn btn-primary" onclick="spinner()">Buat Sertifikat</button>
                                                </div>
                                            </div>
                                        </div>
                        </form>
                ...
                <?php else: ?>
                   <h4> Jika Sertifikat Blank Silahkan klik button <a class="btn btn-primary" href="<?php echo base_url('AkreditasiNonRS/filesertifikatkosong/'.$s->kode_faskes.'/'.$idp) ?>" role="button">REFRESH</a></h4><br/>
                    ...
                    <form class="form-horizontal form-label-left" action="<?= base_url('AkreditasiNonRS/prosesttelembaga') ?>" method="post" enctype="multipart/form-data">
                          <div class="form-group row">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">NIK <span class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 ">
                              <input type="text" name="nik" value="<?php echo $this->session->userdata('nik') ?>" required="required" class="form-control">
                              <input type="hidden" value="<?=$s->lpa_id ?>" name="lembaga" required="required" class="form-control">
                              <input type="hidden" value="<?=$s->id ?>" name="sertifikat_nomor_id" required="required" class="form-control">
                              <input type="hidden" value="<?=$s->jenis_faskes ?>" name="jenis" required="required" class="form-control">
                              <input type="hidden" value="<?=$idp ?>" name="idp" required="required" class="form-control  ">
