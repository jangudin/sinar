...
public function aksi_login()
{
    ...
    // Validasi CAPTCHA
    $captcha_input = $this->input->post('captcha_input');
    $captcha_session = $this->session->userdata('captcha_code');
    if ($captcha_input !== $captcha_session) {
        $this->session->set_flashdata('msg', '<div class="alert alert-danger">Kode CAPTCHA salah.</div>');
        redirect('Auth');
        return;
    }
